/**
 * Count IP Addresses (5 kyu) https://www.codewars.com/kata/526989a41034285187000de4
 * Write a function that accepts a starting and ending IPv4 address, and
 * returns the number of IP addresses from start to end, excluding the end
 * IP address. 
 * All input to the ipsBetween function will be valid IPv4 addresses in the
 * form of strings. The ending address will be at least one address higher
