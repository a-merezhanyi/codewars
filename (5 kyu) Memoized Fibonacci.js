/**
 * Memoized Fibonacci (5 kyu) https://www.codewars.com/kata/memoized-fibonacci
 * Problem Context
 ...
 * fibonacci function twice, and the right branch of recursion (i.e.
 * fibonacci(n-2)) recalculates all the Fibonacci numbers already calculated
 * by the left branch (i.e. fibonacci(n-1)).
